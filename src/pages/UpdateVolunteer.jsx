      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
            ...
            <input
              ...
              name='thumbnail'
              type='url'
              defaultValue={volunter.thumbnail}
          ...
          <div>
            ...
            <input
              ...
              name='location'
              type='text'
              defaultValue={volunter.location}
              className='block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring'
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              type='number'
              defaultValue={volunter.volunteersNeeded}
              className='block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring'
            />
          </div>
        ...
        <div className='flex flex-col gap-2 mt-4'>
          ...
          <textarea
            ...
            name='description'
            id='description'
            defaultValue={volunter.description}
          ></textarea>
        </div>
